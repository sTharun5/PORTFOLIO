...
export const HeroSection = () => {
  return (
    <section id="hero" className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center pt-4 min-h-[80vh]">
      {/* Identity Text */}
      <motion.div 
      ...
      >
        ...
        <h1 className="text-6xl md:text-8xl lg:text-[6.5rem] font-black tracking-tighter mb-8 leading-[0.9] text-slate-900">
          Building <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-indigo-400">Robust</span>
          Logic <br/>
      ...
      >
        <div className="relative w-full max-w-[450px] aspect-[4/5] animate-float-slow group">
          ...
          <TiltCard className="!p-0 border-0 shadow-[0_40px_80px_rgba(0,0,0,0.08)]" padding="p-0" isOverflowHidden={false}>
            {/* Note: In a real Next.js app, we'd use next/image here */}
